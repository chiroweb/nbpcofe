...
export const PRODUCT_DETAILS = [
  {
    ...
    models: [
      { name: "NKIC-5K", capacity: "5kg", target: "중소형 로스터리", specs: { size: "435 × 545 × 1,310mm", burner: "표면연소 고효율 메탈버너", controller: "디지털 컨트롤러", connector: "도시가스 (13A)" }, images: [`${S3}/ab-1k-1.png`] },
      { name: "NKIC-10K", capacity: "10kg", target: "중형 로스터리 카페", specs: { size: "545 × 645 × 1,700mm", burner: "이단연소 고효율 덕트버너", controller: "디지털 컨트롤러", connector: "LPG / 도시가스 (13A)" }, images: [`${S3}/afterburner-white.png`, `${S3}/afterburner-metal.png`] },
      { name: "NKIC-15K", capacity: "15kg", target: "대형 로스터리", specs: { size: "545 × 655 × 1,795mm", burner: "이단연소 고효율 덕트버너", controller: "터치스크린 컨트롤러", connector: "LPG / 도시가스 (13A)" }, images: [`${S3}/ab-15k-2.png`, `${S3}/afterburner-black.png`] },
      { name: "NKIC-30K", capacity: "30kg", target: "산업용 대량 로스팅", specs: { size: "645 × 655 × 1,895mm", burner: "이단연소 고효율 덕트버너", controller: "비례제어", connector: "LPG / 도시가스 (13A)" }, images: [`${S3}/ab-10k-1.jpg`, `${S3}/ab-10k-2.jpg`] },
      { name: "NKIC-60K", capacity: "60kg", target: "대규모 산업 시설", specs: { size: "645 × 750 × 2,190mm", burner: "이단연소 고효율 덕트버너", controller: "비례제어", connector: "LPG / 도시가스 (13A)" }, images: [`${S3}/ab-30k-1.png`] },
      { name: "NKIC-120K", capacity: "120kg", target: "대형 산업 플랜트", specs: { size: "800 × 900 × 2,500mm", burner: "이단연소 고효율 덕트버너", controller: "비례제어", connector: "LPG / 도시가스 (13A)" }, images: [] },
    ],
    compatibleBrands: ["PROBAT", "GIESEN", "LORING", "FUJI ROYAL", "PROASTER", "OZTURK", "DIEDRICH", "TOPER", "BUHLER", "JOPER"],
    image: "https://chiro-web.s3.ap-northeast-2.amazonaws.com/fa/AFTERBUNNER/products/afterburner-main.png",
    gallery: [
      `${S3}/afterburner-black.png`,
      `${S3}/afterburner-white.png`,
      `${S3}/afterburner-metal.png`,
    ],
  },
  {
    id: "roaster",
