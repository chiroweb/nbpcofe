...
export const PRODUCT_DETAILS = [
  {
    ...
    models: [
      { name: "NKIC-1K", capacity: "1kg", target: "소형 샘플 로스터", specs: { size: "355 × 355 × 1,183mm", burner: "표면연소 고효율 메탈버너", controller: "다단제어", connector: "도시가스 (13A)" }, images: [`${S3}/afterburner-black.png`, `${S3}/afterburner-white.png`, `${S3}/afterburner-metal.png`] },
      { name: "NKIC-3K", capacity: "3kg", target: "소형 카페 로스터", specs: { size: "435 × 545 × 1,255mm", burner: "표면연소 고효율 메탈버너", controller: "다단제어", connector: "도시가스 (13A)" }, images: [`${S3}/afterburner-black.png`, `${S3}/afterburner-white.png`, `${S3}/afterburner-metal.png`] },
      { name: "NKIC-5K", capacity: "5kg", target: "중소형 로스터리", specs: { size: "435 × 545 × 1,310mm", burner: "표면연소 고효율 메탈버너", controller: "디지털 컨트롤러", connector: "도시가스 (13A)" }, images: [`${S3}/afterburner-black.png`, `${S3}/afterburner-white.png`, `${S3}/afterburner-metal.png`] },
      { name: "NKIC-10K", capacity: "10kg", target: "중형 로스터리 카페", specs: { size: "545 × 645 × 1,700mm", burner: "이단연소 고효율 덕트버너", controller: "디지털 컨트롤러", connector: "LPG / 도시가스 (13A)" }, images: [`${S3}/afterburner-black.png`, `${S3}/afterburner-white.png`, `${S3}/afterburner-metal.png`] },
      { name: "NKIC-15K", capacity: "15kg", target: "대형 로스터리", specs: { size: "545 × 655 × 1,795mm", burner: "이단연소 고효율 덕트버너", controller: "터치스크린 컨트롤러", connector: "LPG / 도시가스 (13A)" }, images: [`${S3}/afterburner-black.png`, `${S3}/afterburner-white.png`, `${S3}/afterburner-metal.png`] },
      { name: "NKIC-20K", capacity: "20kg", target: "대형 로스팅 공장", specs: { size: "545 × 655 × 1,895mm", burner: "이단연소 고효율 덕트버너", controller: "비례제어", connector: "LPG / 도시가스 (13A)" }, images: [`${S3}/afterburner-black.png`, `${S3}/afterburner-white.png`, `${S3}/afterburner-metal.png`] },
      { name: "NKIC-30K", capacity: "30kg", target: "산업용 대량 로스팅", specs: { size: "645 × 655 × 1,895mm", burner: "이단연소 고효율 덕트버너", controller: "비례제어", connector: "LPG / 도시가스 (13A)" }, images: [`${S3}/afterburner-black.png`, `${S3}/afterburner-white.png`, `${S3}/afterburner-metal.png`] },
